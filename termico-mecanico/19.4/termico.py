...
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(16.529094,53.608595), point1=(24.190605,53.608595))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(42.802142,35.972683), point1=(47.40103500000001,35.972683))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(12.733167,7.099066), point1=(15.738769999999999,7.099066))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(31.957828,15.720347), point1=(35.563134,15.720347))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(21.820781,9.886832), point1=(28.190352,9.886832))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(20.426488,68.281484), point1=(22.863418,68.281484))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(22.733321,36.035493), point1=(28.35356,36.035493))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(37.258641,83.440917), point1=(40.355014,83.440917))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(38.994932,15.830734), point1=(42.170477999999996,15.830734))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(7.118578,81.957337), point1=(12.116896,81.957337))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(37.273903,7.59072), point1=(40.867535,7.59072))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(35.933146,62.442973), point1=(38.611559,62.442973))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(
    center=(10.067473,67.100722), point1=(14.057255999999999,67.100722))
#
...
mdb.models['Model-1'].parts['Part-1'].Set(faces=mdb.models['Model-1'].parts['Part-1'].faces.findAt(
    (( 16.529094 , 53.608595 ,    0.0),),
    (( 42.802142 , 35.972683 ,    0.0),),
    (( 12.733167 , 7.099066 ,    0.0),),
    (( 31.957828 , 15.720347 ,    0.0),),
    (( 21.820781 , 9.886832 ,    0.0),),
    (( 20.426488 , 68.281484 ,    0.0),),
    (( 22.733321 , 36.035493 ,    0.0),),
    (( 37.258641 , 83.440917 ,    0.0),),
    (( 38.994932 , 15.830734 ,    0.0),),
    (( 7.118578 , 81.957337 ,    0.0),),
    (( 37.273903 , 7.59072 ,    0.0),),
    (( 35.933146 , 62.442973 ,    0.0),),
    (( 10.067473 , 67.100722 ,    0.0),),
 ),name='Set-3')
mdb.models['Model-1'].parts['Part-1'].SectionAssignment(offset=0.0,
    offsetField='', offsetType=MIDDLE_SURFACE, region=
...
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 24.190605 , 53.608595 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 47.40103500000001 , 35.972683 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 15.738769999999999 , 7.099066 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 35.563134 , 15.720347 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 28.190352 , 9.886832 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 22.863418 , 68.281484 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 28.35356 , 36.035493 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 40.355014 , 83.440917 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 42.170477999999996 , 15.830734 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 12.116896 , 81.957337 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 40.867535 , 7.59072 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 38.611559 , 62.442973 ,    0.0),),), minSizeFactor=0.1, size=0.5)
mdb.models['Model-1'].parts['Part-1'].seedEdgeBySize(constraint=FINER,
    deviationFactor=0.1, edges = mdb.models['Model-1'].parts['Part-1'].edges.findAt(
        (( 14.057255999999999 , 67.100722 ,    0.0),),), minSizeFactor=0.1, size=0.5)
